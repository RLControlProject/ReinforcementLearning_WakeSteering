...
from windfarmenv_seed4 import WindFarmEnv_v0p12, num_timesteps, num_turbines
...
if __name__ == "__main__":
    ...
    if trainModel:
        ...
        if not load_pretrained_model:
            ...
            if num_turbines == 3:
                subdirectory = "sac_yawseed2_group2/trials/trial_5_10env_1_1"
            elif num_turbines == 18:
                subdirectory = "sac_yawseed2_group2/trials/trial_5_large_10env_1_1"
