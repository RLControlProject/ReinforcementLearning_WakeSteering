...
---------------------- INPUT FILES ---------------------------------------------
"./NRELOffshrBsline5MW_Onshore_ElastoDyn.T12_mod.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"./NRELOffshrBsline5MW_Onshore_ServoDyn.T12_mod.dat" ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
