...
from windfarmenv_seed6 import WindFarmEnv_v0p12, num_timesteps, num_turbines
...
if __name__ == "__main__":
    ...
    if trainModel:
        ...
        venv = VecMonitor(venv=venv0, filename=os.path.join(log_dir,tb_log_name+'_1'), info_keywords=(["r_cumulative", "power", "power_floris_opt_stochastic", "power_floris_opt", "yaw_angles_actual", "yaw_angles", "yaw_angles_floris_opt", "rel_yaw_angles_actual", "rel_yaw_angles", "rel_yaw_angles_floris_opt", "wind_dir", "wind_spd", "turb_int"]))
        ...
        if not load_pretrained_model:
            ...
            if num_turbines == 3:
                subdirectory = "sac_yawseed1_group2/trials/trial_5_10env_1_1"
            elif num_turbines == 18:
                subdirectory = "sac_yawseed1_group2/trials/trial_5_large_10env_1_1"
            modelname = "best_model.zip"
            path = os.path.join(subdirectory,modelname)
            model = SAC.load(path=path,env=venv,device="auto",tensorboard_log=log_dir)#policy_kwargs=policy_kwargs,
