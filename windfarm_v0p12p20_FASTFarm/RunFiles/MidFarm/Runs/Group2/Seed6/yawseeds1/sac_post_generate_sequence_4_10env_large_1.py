...
if __name__ == "__main__":
    ...
    # set up log dir
    if num_turbines == 3:
        tb_log_name = 'trial_4_10env_1'
    elif num_turbines == 8:
        tb_log_name = 'trial_4_10env_medium_1'
    elif num_turbines == 18:
        tb_log_name = 'trial_4_10env_large_1'
    ...
    if trainModel:
        ...
        env_kwargs['rewardtype'] = 'base' # 'DiscreteRandom' 'ContinuousRandom'

        # make the environment

        n_envs = 10
        venv0 = make_vec_env(WindFarmEnv_v0p12,vec_env_cls=SubprocVecEnv, n_envs=n_envs, seed=2, env_kwargs=env_kwargs)
        venv = VecMonitor(
            venv=venv0,
