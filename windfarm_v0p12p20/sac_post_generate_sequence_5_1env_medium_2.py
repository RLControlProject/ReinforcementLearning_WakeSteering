...
python3 sac_post_generate_sequence_5_1env_medium_2.py
"""
...
if __name__ == "__main__":
    ...
    if trainModel:
        ...
        tb_log_name_override = 'trial_5_10env'+tag # for simplicity, reverting to hyperparameters from 10 env, which gives a conservative estimate of peak performance using 1env instead of 10env
