...
python3 sac_post_generate_sequence_4_100env_medium_2.py
"""
...
if __name__ == "__main__":
    ...
    # set up log dir
    tb_log_name = 'trial_4_100env'+tag
    ...
    if trainModel:
        ...
        tb_log_name_override = 'trial_4_10env'+tag # for simplicity, reverting to hyperparameters from 10 env, which gives a conservative estimate of peak performance using 100env instead of 10env
