...
python3 sac_post_generate_sequence_5_10env_extralarge_3.py
"""
...
from windfarm_env_inputindices_extralarge_3 import WindFarmEnv_v1p3, tag, num_timesteps, num_turbines, myseeds
...
if __name__ == "__main__":
    ...
    if trainModel:
        ...
        summary_dir = os.path.join(log_dir_optuna,tb_log_name[:-1]+'1_1','summary')
        ...
        if not load_pretrained_model:
            ...
            subdirectory = "sac_post_generate_sequence/trials/trial_4_10env_extralarge_moremismatch_1"
