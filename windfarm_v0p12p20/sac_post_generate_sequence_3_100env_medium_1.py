...
python3 sac_post_generate_sequence_3_100env_medium_1.py
"""
...
if __name__ == "__main__":
    ...
    # set up log dir
    tb_log_name = 'trial_3_100env'+tag
    ...
    if trainModel:
        ...
        tb_log_name_override = 'trial_3_10env'+tag # for simplicity, reverting to hyperparameters from 10 env, which gives a conservative estimate of peak performance using 100env instead of 10env
        ...
        if not load_pretrained_model:
            ...
            pass
            # subdirectory = "sac_optuna_generate_sequence/trials/trial_3_1"
