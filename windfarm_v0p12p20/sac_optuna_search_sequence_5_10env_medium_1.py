...
python3 sac_optuna_search_sequence_5_10env_medium_1.py > sac_optuna_search_sequence/trials/trial_5_10env_medium_1_1/output.txt
...
from windfarm_env_inputindices_medium_1 import WindFarmEnv_v1p3, tag, num_timesteps, num_turbines
