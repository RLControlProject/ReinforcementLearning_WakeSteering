...
python3 sac_optuna_search_sequence_3_10env_extralarge_1.py > sac_optuna_search_sequence/trials/trial_3_10env_extralarge_1_1/output.txt
...
def train_model(trial, log_dir = '', tb_log_name = ''):
    ...
    train_freq = 1#trial.suggest_int("train_freq", 1,2*n_envs+1, step = n_envs)
