...
cd /ascldap/users/kbrown1/tscratch/Reinforcement_Learning/RLControl/windfarm_v0p12p20/setup/
python3 BaselinePerformance_extralarge_moremismatch.py
"""
...
sys.path.insert(0, '../')
from windfarm_env_inputindices_extralarge_moremismatch import tag, layout_grid, turbine_type, max_yaw_degrees, wind_spd_all,wind_dir_all,turb_int_all, wind_shear, wind_veer, mean_WS, std_dev_WS, mean_TI, std_dev_TI, mean_WD, std_dev_WD, myseeds, yaw_angles_static_offset, FLORIS_path_absolute
